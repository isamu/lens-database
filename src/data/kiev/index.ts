...
export const kievLensDataSet: LensData[] = [
  // ============================================================
  ...
  // ============================================================
  // Jupiter-3M 50mm f/1.5 — multi-coated Sonnar-copy
  // ============================================================
  {
    id: "kiev-jupiter-3m-50mm-f1.5",
    maker: "Kiev",
    name: "Jupiter-3M 50mm F1.5 (Kiev RF)",
    mount: "ContaxRF",
    focalLength: [50],
    fStop: [1.5],
    format: "Full-Frame",
    ...
    discontinued: true,
    discontinuedDate: "1985",
    note: "Later multi-coated iteration of the Jupiter-3 Sonnar 50/1.5 copy — improved contrast and flare over the original single-coated version while preserving classic pre-war Sonnar rendering. Arsenal Kiev / KMZ Krasnogorsk.",
  },
  // ============================================================
  // Jupiter-3MC 50mm f/1.5 — final multi-coated gen
  // ============================================================
  {
    id: "kiev-jupiter-3mc-50mm-f1.5",
    maker: "Kiev",
    name: "Jupiter-3MC 50mm F1.5 (Kiev RF)",
    mount: "ContaxRF",
    focalLength: [50],
    fStop: [1.5],
    format: "Full-Frame",
    ...
    note: "Final multi-coated (МЦ) generation of the Jupiter-3 family — cult grail among Sonnar-copy shooters for having modern coatings on a pre-war Bertele Sonnar 50/1.5 recipe. Arsenal Kiev.",
  },
  // ============================================================
  // Jupiter-8NB 50mm f/2 — later black-body
  // ============================================================
  {
    id: "kiev-jupiter-8nb-50mm-f2",
    maker: "Kiev",
    name: "Jupiter-8NB 50mm F2 (Kiev RF)",
    mount: "ContaxRF",
    focalLength: [50],
    fStop: [2],
    format: "Full-Frame",
    ...
    discontinued: true,
    discontinuedDate: "1985",
    note: "Later black-body Jupiter-8 variant, click-stopped and multi-coated. Uncommon export version of the Sonnar 50/2 copy. Arsenal Kiev.",
  },
  // ============================================================
  // Jupiter-12M 35mm f/2.8 — multi-coated Biogon-copy
  // ============================================================
  {
    id: "kiev-jupiter-12m-35mm-f2.8",
    maker: "Kiev",
    name: "Jupiter-12M 35mm F2.8 (Kiev RF)",
    mount: "ContaxRF",
    focalLength: [35],
    fStop: [2.8],
    format: "Full-Frame",
    ...
    discontinued: true,
    discontinuedDate: "1985",
    note: "Later multi-coated variant of the Jupiter-12 Biogon 35/2.8 copy. Still carries the deeply protruding rear element that makes body compatibility a puzzle, but modern coatings tame the classic Biogon flare. Arsenal Kiev.",
  },
  // ============================================================
  // Jupiter-17M 50mm f/2 — rare late variant
  // ============================================================
  {
    id: "kiev-jupiter-17m-50mm-f2",
    maker: "Kiev",
    name: "Jupiter-17M 50mm F2 (Kiev RF)",
    mount: "ContaxRF",
    focalLength: [50],
    fStop: [2],
    format: "Full-Frame",
    ...
    discontinued: true,
    discontinuedDate: "1985",
    note: "Very rare late Soviet 50/2 for Kiev RF — a small-run prototype series in the Jupiter line. Collector curio, factory attribution disputed. KMZ / Arsenal Kiev.",
  },
  // ============================================================
  // Helios-94 50mm f/1.4 — rare Soviet fast normal
  // ============================================================
  {
    id: "kiev-helios-94-50mm-f1.4",
    maker: "Kiev",
    name: "Helios-94 50mm F1.4 (Kiev RF)",
    mount: "ContaxRF",
    focalLength: [50],
    fStop: [1.4],
    format: "Full-Frame",
    ...
    discontinued: true,
    discontinuedDate: "1990",
    note: "Extremely rare Soviet fast fifty in Contax RF mount — a Planar-derived double-Gauss going beyond the Helios-103's F1.8. Almost never seen in the wild; collector grail. Arsenal Kiev.",
  },
  // ============================================================
  // Volna-3 50mm f/1.5 — Kiev RF version
  // ============================================================
  {
    id: "kiev-volna-3-50mm-f1.5",
    maker: "Kiev",
    name: "Volna-3 50mm F1.5 (Kiev RF)",
    mount: "ContaxRF",
    focalLength: [50],
    fStop: [1.5],
    format: "Full-Frame",
    ...
    discontinued: true,
    discontinuedDate: "1990",
    note: "Rare Kiev RF variant of the Volna-3 fast fifty (better known in Pentacon Six as a 80/2.8). Sonnar-family multi-coated glass, cult collector item. Arsenal Kiev.",
  },
];
export * from "./p6";
